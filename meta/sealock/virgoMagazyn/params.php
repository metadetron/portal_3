...
<?php
			$options = array();
			$options["mgz_id"] = "id";
			$options["mgz_nazwa"] = "Nazwa";

			$options["mgz_opis"] = "Opis";
...
?>
		<tr>
			<td title="eg. mgz_abc_id in (select abc_id from...)) ">extra_ajax_filter</td>
			<td>
...
?>
		<tr>
			<td title="Custom SQL condition (eg. mgz_abc_id in (select abc_id from...)) You can use classes $currentUser and $currentPage (eg. mgz_usr_created_id = {$user->getId()})">custom_sql_condition</td>
			<td>
...
<?php 
	if (isset($_POST['HINT_magazyn'])) {
		$newHint = $_POST['HINT_magazyn'];
	...
	$result = $databaseHandler->queryPrepared($query, false, "s", array('HINT_magazyn'));
	foreach ($result as $res) {
		$hintId = $row[trn_id];
		$hintText = $row[trn_text];
			...
			if (isset($hintId)) {
				if ($newHint != $hintText) {
					...
					$query = " INSERT INTO prt_translations (trn_lng_id, trn_token, trn_text) VALUES (" . $lngId . ", 'HINT_magazyn', '" . $newHint . "')";
			}
		} else {
	$hintId = null;
	$hintText = null;
...
?>
	<tr>
		<td>HINT_magazyn</td>
		<td colspan="2"><textarea cols="60" rows="4" name="HINT_magazyn"><?php echo $text ?></textarea></td>
		<td>
			<input type="submit" value="Store"/>
		</td>			
	</tr>
<?php 
	if (isset($_POST['HINT_magazyn_nazwa'])) {
		$newHint = $_POST['HINT_magazyn_nazwa'];
		$newHint = trim($newHint);
		if ($newHint == "") {
			$newHint = null;
		}
	...
	$hintText = null;
	$query = " SELECT trn_id, trn_text FROM prt_translations WHERE trn_token = ? AND trn_lng_id = " . $lngId;
	$result = $databaseHandler->queryPrepared($query, false, "s", array('HINT_magazyn_nazwa'));
	foreach ($result as $res) {
		$hintId = $row[trn_id];
		$hintText = $row[trn_text];
	}
			if (isset($hintId)) {
				if ($newHint != $hintText) {
					...
					$query = " INSERT INTO prt_translations (trn_lng_id, trn_token, trn_text) VALUES (" . $lngId . ", 'HINT_magazyn_nazwa', '" . $newHint . "')";
			}
		} else {
	$hintId = null;
	$hintText = null;
...
?>
	<tr>
		<td>HINT_magazyn_nazwa</td>
		<td colspan="2"><textarea cols="60" rows="4" name="HINT_magazyn_nazwa"><?php echo $text ?></textarea></td>
		<td>
			<input type="submit" value="Store"/>
		</td>			
	</tr>
<?php 
	if (isset($_POST['HINT_magazyn_opis'])) {
		$newHint = $_POST['HINT_magazyn_opis'];
		$newHint = trim($newHint);
		if ($newHint == "") {
			$newHint = null;
		}
	...
	$hintText = null;
	$query = " SELECT trn_id, trn_text FROM prt_translations WHERE trn_token = ? AND trn_lng_id = " . $lngId;
	$result = $databaseHandler->queryPrepared($query, false, "s", array('HINT_magazyn_opis'));
	foreach ($result as $res) {
		$hintId = $row[trn_id];
		$hintText = $row[trn_text];
	}
			if (isset($hintId)) {
				if ($newHint != $hintText) {
					...
					$query = " INSERT INTO prt_translations (trn_lng_id, trn_token, trn_text) VALUES (" . $lngId . ", 'HINT_magazyn_opis', '" . $newHint . "')";
			}
		} else {
	$hintId = null;
	$hintText = null;
...
?>
	<tr>
		<td>HINT_magazyn_opis</td>
		<td colspan="2"><textarea cols="60" rows="4" name="HINT_magazyn_opis"><?php echo $text ?></textarea></td>
		<td>
			<input type="submit" value="Store"/>
		</td>			
	</tr>
...
<tr><td></td><td></td><td></td><td></td></tr>
<?php 
	if (isset($_POST['HINT_magazyn_bilansy_otwarcia'])) {
		$newHint = $_POST['HINT_magazyn_bilansy_otwarcia'];
		$newHint = trim($newHint);
		if ($newHint == "") {
			$newHint = null;
		}
	...
	$hintText = null;
	$query = " SELECT trn_id, trn_text FROM prt_translations WHERE trn_token = ? AND trn_lng_id = " . $lngId;
	$result = $databaseHandler->queryPrepared($query, false, "s", array('HINT_magazyn_bilansy_otwarcia'));
	foreach ($result as $res) {
		$hintId = $row[trn_id];
		$hintText = $row[trn_text];
	}
			if (isset($hintId)) {
				if ($newHint != $hintText) {
					...
					$query = " INSERT INTO prt_translations (trn_lng_id, trn_token, trn_text) VALUES (" . $lngId . ", 'HINT_magazyn_bilansy_otwarcia', '" . $newHint . "')";
			}
		} else {
	$hintId = null;
	$hintText = null;
...
?>
	<tr>
		<td>HINT_magazyn_bilansy_otwarcia</td>
		<td colspan="2"><textarea cols="60" rows="4" name="HINT_magazyn_bilansy_otwarcia"><?php echo $text ?></textarea></td>
		<td>
			<input type="submit" value="Store"/>
		</td>			
	</tr>
